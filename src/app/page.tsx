...
// ✅ AdBanner component (for Adsterra or any ad network)
    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-background p-4 sm:p-8 diwali-background">
      ...
      <div className="mt-8 w-full max-w-md rounded-lg bg-black/20 p-6 shadow-2xl backdrop-blur-sm">
        <div className="space-y-2 text-center mb-6">
          <h2
            className="text-2xl font-headline text-white"
            style={{ fontFamily: "'Lobster', cursive" }}
          >
            Share your own wish!
          </h2>
          <p className="text-yellow-200/80 text-sm">
            Enter your name and share with friends.
          </p>
        </div>
        <div className="flex items-center gap-4">
          <div className="flex-shrink-0 w-10 h-10 bg-black flex items-center justify-center rounded-md font-bold text-white text-xl">
            N
          </div>
          <Input
            id="fromName"
...
export default function Home() {
  return (
    <Suspense
      fallback={
        <div className="flex min-h-screen items-center justify-center diwali-background text-white">
          Loading...
        </div>
      }
    >
